...
public class WzimMap<K, V> implements java.util.Map<K, V> {
    ...
    @Override
    public WzimSet keySet() {
        WzimSet<K> result = new WzimSet<>();
        for (K key : keys) {
            result.add(key);
        }
    ...
    public Collection values() {
        WzimList<V> result = new WzimList<>();
        for (V value : values) {
            result.add(value);
        }
    ...
    @Override
    public WzimSet entrySet() {
        WzimSet<Entry> result = new WzimSet<>();
        for (int i = 0; i < index; i++) {
